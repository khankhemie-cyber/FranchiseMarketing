      ...
      <section className="bg-[#EDE9E3] pt-40 pb-24 px-6 lg:px-10">
        <div className="max-w-5xl mx-auto">
          ...
          <p className="text-[18px] sm:text-[20px] text-[#4A5568] leading-relaxed max-w-2xl">
            Sova evaluates 1,300+ active Canadian franchise brands on four equally weighted pillars. Scores are calculated from franchisee surveys, platform data, and publicly available information. The ranking is updated annually each spring.
          </p>
        </div>
      </section>
